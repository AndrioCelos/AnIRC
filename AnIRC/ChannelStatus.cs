...
/// <summary>Represents an immutable set of status modes a user has on a channel.</summary>
/// <example>
...
///     </code>
///     If the network doesn't have halfops, the check becomes equivalent to <c>(me.Status >= ChannelStatus.Op)</c>.
/// </example>
public class ChannelStatus : ISet<char>, IReadOnlyCollection<char>, IComparable<ChannelStatus>, IEquatable<ChannelStatus> {
	...
	/// <summary>Returns whether this set contains no modes.</summary>
	public bool IsEmpty => this.modes.Count == 0;
	...
	/// <summary>Returns a <see cref="ChannelStatus"/> object that represents no status and is not associated with any network.</summary>
	public static ChannelStatus Empty  { get; } = new(null);
	...
	public static ChannelStatus Voice  { get; } = new(null);
	...
	public static ChannelStatus Halfop { get; } = new(null);
	...
	public static ChannelStatus Op     { get; } = new(null);
	...
	public static ChannelStatus Admin  { get; } = new(null);
	...
	public static ChannelStatus Owner  { get; } = new(null);
	...
	[Obsolete($"This constructor is deprecated. Use {nameof(ChannelStatus)}.{nameof(Empty)} instead.")]
